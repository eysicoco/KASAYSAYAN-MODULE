...
<!-- CONTENTS -->	
    ...
    <section class="content-section">
        ...
        <div class="rectangle-container">
            ...
            <!-- 15 rectangle boxes -->
           <div class="rectangle">
			<img src="../PICS/WT.jpg" alt="Image">
			<div class="text">Lesson 1</div>
			<div class="dropdown">
        <a href="../QUIZ1/pretest1.php">Pre-test</a>
        <a href="../QUIZ1/posttest1.php">Post-test</a>
    </div>
			</div>
			
            <div class="rectangle">
			<img src="../PICS/WT.jpg" alt="Image">
			<div class="text">Lesson 2</div>
			<div class="dropdown">
        <a href="../QUIZ1/pretest1.php">Pre-test</a>
        <a href="../QUIZ1/posttest1.php">Post-test</a>
    </div>
